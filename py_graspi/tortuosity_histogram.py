...
def find_coords(filename):
    ...
    with open(f"{current_dir}/data/{filename}", "r") as file:
...
def read_BTR_file_and_extract_numbers(base_filename):
    ...
    file_path = f"{current_dir}/data/data_{base_filename}_IdTortuosityBlackToRed.txt"
    idOfPixelIn1DArray = []
    tort = []
...
def read_WTB_file_and_extract_numbers(base_filename):
    ...
    file_path = f"{current_dir}/data/data_{base_filename}_IdTortuosityWhiteToBlue.txt"
