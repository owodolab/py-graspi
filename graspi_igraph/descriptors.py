...
def CC_descriptors(graph, totalBlack, totalWhite):
    ...
    return countBlack, countWhite, countBlack_Red, countWhite_Blue, round(countBlack_Red_conn / totalBlack, 6), round(
        countWhite_Blue_conn / totalWhite, 6)
...
def descriptors(graph, filename, black_vertices, white_vertices, black_green, black_interface_red, white_interface_blue,
                dim, interface_edge_comp_paths, shortest_path_to_red, shortest_path_to_blue, CT_n_D_adj_An,
                CT_n_A_adj_Ca):
    """
    ...
    STAT_CC_D, STAT_CC_A, STAT_CC_D_An, STAT_CC_A_Ca, CT_f_conn_D_An, CT_f_conn_A_Ca = CC_descriptors(graph, STAT_n_D,
                                                                                                      STAT_n_A)

    # shortest path descriptors
    DISS_f10_D, DISS_wf10_D, CT_f_D_tort1, CT_f_A_tort1 = shortest_path_descriptors(graph, filename, black_vertices,
                                                                                    white_vertices, dim,
                                                                                    shortest_path_to_red,
                                                                                    shortest_path_to_blue)
