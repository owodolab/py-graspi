...
def CT_n_D_adj_An(graph):
    ...
    for edge in edgeList:
        ...
        # check if the edge is connected the red metavertex
        if(graph.vs[currentNode]['color'] == 'red' or graph.vs[toNode]['color'] == 'red'):
            # check if the endpoints of the edges are either red or black
...
def CT_n_A_adj_Ca(graph):
    ...
    for edge in edgeList:
        ...
        # check if the edge is connected the blue metavertex
        if(graph.vs[currentNode]['color'] == 'blue' or graph.vs[toNode]['color'] == 'blue'):
            # check if the endpoints of the edges are either blue or white
